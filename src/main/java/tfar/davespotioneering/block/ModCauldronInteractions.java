...
public class ModCauldronInteractions {
        ...
        static final CauldronBehavior FILL_WATER = (state, world, pos, p_175686_, p_175687_, p_175688_) -> {
            ActionResult actionResult = CauldronBehavior.fillCauldron(world, pos, p_175686_, p_175687_, p_175688_, ModBlocks.REINFORCED_WATER_CAULDRON.getDefaultState().with(LeveledCauldronBlock.LEVEL, 3), SoundEvents.ITEM_BUCKET_EMPTY);
