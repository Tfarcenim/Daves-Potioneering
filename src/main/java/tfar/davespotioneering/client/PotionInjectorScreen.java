...
public class PotionInjectorScreen extends HandledScreen<PotionInjectorMenu> {
    ...
    protected void init() {
        ...
        int y = this.y + 76;
        int w = 24;
        addDrawableChild(new ButtonWidget(x,y,36,20,Text.literal("Strip"),this::strip){
            @Override
        ...
        addDrawableChild(new ButtonWidget(x + 46,y,36,20,Text.literal("Inject"),this::inject){
            @Override
            public void playDownSound(SoundManager handler) {
