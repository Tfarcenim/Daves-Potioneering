...
public class ModLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(GauntletHUDMovementScreen.KEY+ HudPreset.TOP_LEFT.ordinal(), "Left Top");
        add(GauntletHUDMovementScreen.KEY+ HudPreset.TOP_RIGHT.ordinal(), "Right Top");
        add(GauntletHUDMovementScreen.KEY+ HudPreset.BTM_LEFT.ordinal(), "Left Bottom");
        add(GauntletHUDMovementScreen.KEY+ HudPreset.BTM_RIGHT.ordinal(), "Right Bottom");
        add(GauntletHUDMovementScreen.KEY+ HudPreset.ABOVE_HOTBAR.ordinal(), "Above Hotbar");
