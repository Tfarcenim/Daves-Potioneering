...
public class GeoItemStackRenderer<T extends IAnimatable> implements IGeoRenderer<T>, BuiltinItemRendererRegistry.DynamicItemRenderer  {
    ...
    public GeoItemStackRenderer(AnimatedGeoModel<T> modelProvider, T ianimatable,BlockEntityRenderDispatcher blockEntityRenderDispatcher, EntityModelSet entityModelLoader) {
        this(modelProvider, RenderType::entityCutout, ianimatable,blockEntityRenderDispatcher,entityModelLoader);
    }

    public GeoItemStackRenderer(AnimatedGeoModel<T> modelProvider, Function<ResourceLocation, RenderType> renderTypeGetter, T ianimatable, BlockEntityRenderDispatcher blockEntityRenderDispatcher, EntityModelSet entityModelLoader) {
    ...
    //render
    public void render(ItemStack stack, ItemTransforms.Mode transformType, PoseStack matrices, MultiBufferSource bufferIn,
            int combinedLightIn,
            int p_239207_6_
    ) {
    ...
    public void render1(PoseStack matrices, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
