...
public class AdvancedBrewingStandScreen extends AbstractContainerScreen<AdvancedBrewingStandContainer> {
    ...
    private static final ResourceLocation BREWING_STAND_GUI_TEXTURES = new ResourceLocation(DavesPotioneeringFabric.MODID,"textures/gui/compound_brewing_stand.png");
